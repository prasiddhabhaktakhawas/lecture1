...
## Mobile Responsiveness:
	...
	1. In the home page, the number of columns occupied by the contents change. When the window width decreases the image comes down and the size of the images and icons changes. The font size of my interests and its description decreases.
	2. In the skills page, the text size of the description decreases and the table shrinks as I have used grid table. The size of the logos also changes.
	3. In the gaming page, the size of text changes and only 1 game is displayed in 1 row.
	4. In the movies page, the font size of the description and the list decreases.
	5. In the about page, the font size of the description decreases.
	6. The font size of the navigation menu decreases and the icons in the footer and its corresponding text also decreases in size. In addition, the columns taken by element of the footer also changes. 


You may be able of view my website working at draperspider.ml . I have uploaded it through www.000webhost.com.
